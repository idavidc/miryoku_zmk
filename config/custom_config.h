...
&kp DOUBLE_QUOTES, &kp DLLR,          &kp PRCNT,         &kp CARET,         &kp PLUS,          U_NA,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
...
U_CUT,             &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,      &to 11,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp PG_DN,         &kp PG_UP,         &kp INS,           &kp HOME,          &kp END,           &kp X,              &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          U_NA,              \
...
U_NP,              U_NP,              &kp ESC,         U_LT(U_NAV, V), &kp SPACE,         U_NA,              U_NA,              U_NA,              U_NP,              U_NP 
